...
wc(int fd, char *name)
{
  ...
  aa:	8b250513          	add	a0,a0,-1870 # 958 <malloc+0x100>
  ...
  d8:	87450513          	add	a0,a0,-1932 # 948 <malloc+0xf0>
...
main(int argc, char *argv[])
{
 ...
 154:	81858593          	add	a1,a1,-2024 # 968 <malloc+0x110>
 158:	4501                	li	a0,0
