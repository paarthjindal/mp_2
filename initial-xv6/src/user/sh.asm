...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2d858593          	add	a1,a1,728 # 1338 <malloc+0xfa>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2a650513          	add	a0,a0,678 # 1340 <malloc+0x102>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	37a70713          	add	a4,a4,890 # 1440 <malloc+0x202>
    ...
    panic("runcmd");
      ...
      e4:	26850513          	add	a0,a0,616 # 1348 <malloc+0x10a>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	24e58593          	add	a1,a1,590 # 1350 <malloc+0x112>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	21258593          	add	a1,a1,530 # 1360 <malloc+0x122>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	18c50513          	add	a0,a0,396 # 1370 <malloc+0x132>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	de2b8b93          	add	s7,s7,-542 # 1398 <malloc+0x15a>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	db050513          	add	a0,a0,-592 # 1378 <malloc+0x13a>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	cf060613          	add	a2,a2,-784 # 13a0 <malloc+0x162>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	ce0b0b13          	add	s6,s6,-800 # 13c0 <malloc+0x182>
  ...
  return ret;
     ...
     71e:	c8e50513          	add	a0,a0,-882 # 13a8 <malloc+0x16a>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c3450513          	add	a0,a0,-972 # 13b0 <malloc+0x172>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	c1260613          	add	a2,a2,-1006 # 13c8 <malloc+0x18a>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	baaa0a13          	add	s4,s4,-1110 # 13d0 <malloc+0x192>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	b7c60613          	add	a2,a2,-1156 # 13d8 <malloc+0x19a>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	ade60613          	add	a2,a2,-1314 # 13a0 <malloc+0x162>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	afe60613          	add	a2,a2,-1282 # 13f0 <malloc+0x1b2>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	ae870713          	add	a4,a4,-1304 # 1458 <malloc+0x21a>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	9f460613          	add	a2,a2,-1548 # 1410 <malloc+0x1d2>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    panic("syntax");
     ...
     a68:	94450513          	add	a0,a0,-1724 # 13a8 <malloc+0x16a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10e8:	38c90913          	add	s2,s2,908 # 1470 <malloc+0x232>
        while(*s != 0){
